        ...
        <form id="editForm" class="p-6 space-y-4">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4 mb-2">
                    <img id="editPreview" class="w-16 h-16 rounded-full object-cover border-2 border-gray-200" style="display:none">
                    <p id="noImageText" class="text-sm text-gray-400">Tidak ada avatar</p>
                </div>
                <input type="file" name="avatar" accept="image/*" onchange="previewEditImage(event)"
                ...
                <span class="text-red-500 text-xs" id="error-edit-avatar"></span>
            </div>
            ...
            <div>
                ...
                <span class="text-red-500 text-xs" id="error-edit-username"></span>
            </div>

            <!-- Password (optional) -->
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Password Baru <span class="text-gray-400 text-xs">(kosongkan jika tidak diubah)</span></label>
                <div class="relative">
                ...
                <span class="text-red-500 text-xs" id="error-edit-password"></span>
            </div>

            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Confirm Password Baru</label>
                <div class="relative">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <span class="text-red-500 text-xs" id="error-edit-role_id"></span>
                </div>
                <div>
                    ...
                    <span class="text-red-500 text-xs" id="error-edit-status"></span>
                </div>
            </div>
